...
<div class="container">
        <div class="row">
            <div class="col">
                <div class="card">
                    <div class="card-header">add Stok Barang</div>
                    <div class="card-body">
                        <form action="{{ route('stok.store') }}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jumlahbarangmasuk"
                                    class="form-control
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jumblahbarangkeluar"
                                    class="form-control
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="jumblahstok"
                                    class="form-control
